...
// src/modules/updates/updates.service.js
import { logger } from "@repo/logger";
import { generateId, IDPrefix } from "@repo/id";
import { db, stockUpdates } from "@repo/db";

// ../../node_modules/.pnpm/drizzle-orm@0.30.10_bun-types@1.2.3_react@18.3.1/node_modules/drizzle-orm/entity.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.30.10_bun-types@1.2.3_react@18.3.1/node_modules/drizzle-orm/column.js
class Column {
...
// ../../node_modules/.pnpm/drizzle-orm@0.30.10_bun-types@1.2.3_react@18.3.1/node_modules/drizzle-orm/table.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.30.10_bun-types@1.2.3_react@18.3.1/node_modules/drizzle-orm/pg-core/table.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.30.10_bun-types@1.2.3_react@18.3.1/node_modules/drizzle-orm/tracing-utils.js
function iife(fn, ...args) {
  return fn(...args);
}

// ../../node_modules/.pnpm/drizzle-orm@0.30.10_bun-types@1.2.3_react@18.3.1/node_modules/drizzle-orm/pg-core/unique-constraint.js
function uniqueKeyName(table, columns) {
  return `${table[PgTable.Symbol.Name]}_${columns.join("_")}_unique`;
}

// ../../node_modules/.pnpm/drizzle-orm@0.30.10_bun-types@1.2.3_react@18.3.1/node_modules/drizzle-orm/pg-core/columns/common.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.30.10_bun-types@1.2.3_react@18.3.1/node_modules/drizzle-orm/pg-core/columns/enum.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.30.10_bun-types@1.2.3_react@18.3.1/node_modules/drizzle-orm/subquery.js
class Subquery {
...
// ../../node_modules/.pnpm/drizzle-orm@0.30.10_bun-types@1.2.3_react@18.3.1/node_modules/drizzle-orm/version.js
var version = "0.30.10";

// ../../node_modules/.pnpm/drizzle-orm@0.30.10_bun-types@1.2.3_react@18.3.1/node_modules/drizzle-orm/tracing.js
var otel;
var rawTracer;
var tracer = {
...
// ../../node_modules/.pnpm/drizzle-orm@0.30.10_bun-types@1.2.3_react@18.3.1/node_modules/drizzle-orm/view-common.js
var ViewBaseConfig = Symbol.for("drizzle:ViewBaseConfig");

// ../../node_modules/.pnpm/drizzle-orm@0.30.10_bun-types@1.2.3_react@18.3.1/node_modules/drizzle-orm/sql/sql.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.30.10_bun-types@1.2.3_react@18.3.1/node_modules/drizzle-orm/sql/expressions/conditions.js
...
// src/modules/updates/updates.service.js
var serviceLogger = logger.child({ component: "updates-service" });
var updatesService = {
  ...
  async getStockUpdatesByTicker(ticker) {
    ...
    try {
      const updates = await db.select().from(stockUpdates).where(eq(stockUpdates.ticker, ticker)).orderBy(stockUpdates.createdAt, "desc");
  ...
  async getAllStockUpdates() {
    ...
    try {
      const updates = await db.select().from(stockUpdates).orderBy(stockUpdates.createdAt, "desc").limit(100);
...
// src/modules/updates/updates.routes.ts
var routeLogger = logger2.child({ component: "updates-routes" });
...
var updatesRoutes = new Hono2().post("/", async (c) => {
  try {
...
// src/modules/ai-triggers/ai-triggers.service.js
import { logger as logger3 } from "@repo/logger";
import { generateId as generateId2, IDPrefix as IDPrefix2 } from "@repo/id";
import { db as db2, aiTriggers } from "@repo/db";
var serviceLogger2 = logger3.child({ component: "ai-triggers-service" });
var aiTriggersService = {
  async registerTrigger(data) {
    serviceLogger2.info("Registering AI trigger", { ticker: data.ticker, eventType: data.event_type });
    try {
      const id = generateId2(IDPrefix2.TRIGGER);
      const now = new Date;
      await db2.insert(aiTriggers).values({
        id,
        ticker: data.ticker,
      ...
      serviceLogger2.info("Successfully registered AI trigger", { id, ticker: data.ticker });
      return { id };
    } catch (error) {
      serviceLogger2.error("Database error registering AI trigger", {
        error: error.message,
        stack: error.stack,
        ticker: data.ticker
      });
  ...
  async getRecentTriggers(ticker) {
    serviceLogger2.info("Getting recent triggers", { ticker });
    try {
      const triggers = await db2.select().from(aiTriggers).where(eq(aiTriggers.ticker, ticker)).orderBy(aiTriggers.timestamp, "desc").limit(20);
      serviceLogger2.info(`Found ${triggers.length} AI triggers for ticker ${ticker}`);
      return triggers;
    } catch (error) {
      serviceLogger2.error("Database error fetching AI triggers by ticker", {
        error: error.message,
        stack: error.stack,
        ticker
      });
  ...
  async getAllTriggers() {
    serviceLogger2.info("Getting all triggers");
    try {
      const triggers = await db2.select().from(aiTriggers).orderBy(aiTriggers.timestamp, "desc").limit(50);
      serviceLogger2.info(`Found ${triggers.length} AI triggers`);
      return triggers;
    } catch (error) {
      serviceLogger2.error("Database error fetching all AI triggers", {
        error: error.message,
        stack: error.stack
      });
      throw error;
...
var routeLogger2 = logger4.child({ component: "ai-triggers-routes" });
var triggerSchema = z.object({
  ticker: z.string(),
  event_type: z.string(),
  details: z.record(z.any()).optional()
});
var aiTriggersRoutes = new Hono2().post("/", async (c) => {
  try {
    const body = await c.req.json();
    ...
    const data = validation.data;
    routeLogger2.info("Registering AI trigger", {
      ticker: data.ticker,
      eventType: data.event_type
    });
    ...
    routeLogger2.error("Error registering AI trigger", {
      error: error.message,
      stack: error.stack
    });
    return c.json({
  ...
  try {
    const ticker = c.req.param("ticker");
    routeLogger2.info("Getting recent triggers", { ticker });
    const triggers = await aiTriggersService.getRecentTriggers(ticker);
    return c.json({ triggers });
  } catch (error) {
    routeLogger2.error("Error getting triggers", {
      error: error.message,
      stack: error.stack,
      ticker: c.req.param("ticker")
    });
  ...
  try {
    routeLogger2.info("Getting all triggers");
    const triggers = await aiTriggersService.getAllTriggers();
    return c.json({ triggers });
  } catch (error) {
    routeLogger2.error("Error getting all triggers", {
      error: error.message,
      stack: error.stack
    });
    return c.json({
...
var userPreferencesStore = new Map;
var usersService = {
...
// src/modules/users/users.routes.ts
var routeLogger3 = logger5.child({ component: "users-routes" });
...
var userRoutes = new Hono2().post("/preferences", async (c) => {
  try {
    const body = await c.req.json();
    ...
    const data = validation.data;
    routeLogger3.info("Received user preferences update", { userId: data.userId });
    ...
    routeLogger3.error("Error saving user preferences", {
      error: error instanceof Error ? error.message : String(error),
      stack: error instanceof Error ? error.stack : undefined
    });
    return c.json({
  ...
  try {
    ...
    routeLogger3.info("Fetching user preferences", { userId });
    ...
    routeLogger3.error("Error fetching user preferences", {
      error: error instanceof Error ? error.message : String(error),
      stack: error instanceof Error ? error.stack : undefined,
  ...
  try {
    routeLogger3.info("Fetching all users");
    const users = await usersService.getAllUsers();
    return c.json({ users });
  } catch (error) {
    routeLogger3.error("Error fetching all users", {
      error: error instanceof Error ? error.message : String(error),
      stack: error instanceof Error ? error.stack : undefined
    });
    return c.json({
...
app.use("*", async (c, next) => {
  logger6.info(`${c.req.method} ${c.req.url}`);
  await next();
});
...
app.onError((err, c) => {
  logger6.error("Error in request", { error: err.message, stack: err.stack, url: c.req.url });
  return c.json({ status: "error", message: err.message, code: 500 }, 500);
});
var port = parseInt(process.env.PORT || "3002");
var host = process.env.HOST || "0.0.0.0";
logger6.info(`Starting server on ${host}:${port}`);
var src_default = {
  port,
  fetch: app.fetch
};
