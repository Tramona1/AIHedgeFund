 ...
 */
unusualWhalesRoutes.get("/options-flow", zValidator("query", symbolQuerySchema), async (c) => {
    try {
 ...
 */
unusualWhalesRoutes.get("/dark-pool", zValidator("query", symbolQuerySchema), async (c) => {
    try {
        const { symbol, limit } = c.req.valid("query");
 ...
 */
unusualWhalesRoutes.get("/market-sentiment", async (c) => {
    try {
 ...
 */
unusualWhalesRoutes.post("/collect", zValidator("json", z.object({
    symbol: z.string().optional(),
 ...
 */
unusualWhalesRoutes.get("/status", async (c) => {
    try {
