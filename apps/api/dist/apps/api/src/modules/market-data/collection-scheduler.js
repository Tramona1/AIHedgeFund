...
export class CollectionScheduler {
    ...
    checkMarketHours() {
        try {
            ...
            const isMarketHours = (etHour > 9 || (etHour === 9 && minute >= 30)) && // After 9:30 AM ET
    ...
    async collectWatchlistData() {
        try {
            ...
            const successCount = results.filter(r => r.quote?.success ||
                r.company?.success ||
                r.balanceSheet?.success ||
                r.rsi?.success).length;
...
//# sourceMappingURL=collection-scheduler.js.map