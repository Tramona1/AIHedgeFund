...
class WeeklyNewsletterService {
     ...
     * @param user User with newsletter preferences
     */
    async generateAndSendUserNewsletter(user) {
        try {
     ...
     */
    async generateNewsletterContent(user) {
     ...
     */
    async getTradingRecommendations(user) {
        try {
     ...
     */
    analyzeOptionsFlow(optionsData) {
        const insights = [];
        // Group by ticker
        const byTicker = {};
     ...
     */
    analyzeDarkPoolActivity(darkPoolData) {
        const insights = [];
        // Group by ticker
        const byTicker = {};
...
//# sourceMappingURL=weekly-newsletter.service.js.map