...
export class UnusualWhalesService {
   ...
   */
  async getOptionsFlow(symbol?: string, limit: number = 50): Promise<any> {
   ...
   * @param limit Number of records to return
   */
  async getDarkPoolData(symbol?: string, limit: number = 50): Promise<any> {
   ...
   */
  async getOptionsData(symbol: string, expiration?: string): Promise<any> {
